...
import { CAPTURE_BUTTON_SIZE, SCREEN_WIDTH, SAFE_BOTTOM } from './Constants';
...
const _CaptureButton: React.FC<Props> = ({
  ...
  const captureButtonBottom = SAFE_BOTTOM * 3;
  ...
  >({
    ...
    onActive: (event, context) => {
      ...
      const startY = context.startY ?? 500;
      ...
      <Reanimated.View {...props} style={[buttonStyle, style]}>
        <PanGestureHandler
          ...
          <Reanimated.View style={styles.flex}>
            ...
            />
            <View style={[styles.button, { bottom: captureButtonBottom }]} />
          </Reanimated.View>
        </PanGestureHandler>
      </Reanimated.View>
    </TapGestureHandler>
