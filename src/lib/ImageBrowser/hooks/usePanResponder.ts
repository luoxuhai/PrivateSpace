...
> => {
  ...
  const fitsScreenByWidth = () =>
    imageDimensions.width * currentScale < SCREEN.width;
  const fitsScreenByHeight = () =>
    imageDimensions.height * currentScale < SCREEN.height;
          ...
          : getTranslateInBounds(
              {
                x:
                  initialTranslate.x +
                  (SCREEN.width / 2 - touchX) * (targetScale / currentScale),
                y:
                  initialTranslate.y +
                  (SCREEN.height / 2 - touchY) * (targetScale / currentScale),
              },
              targetScale,
            );
