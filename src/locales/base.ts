export default {
  ...
  common: {
    emptyDataTextUnversioned: '暂无数据',
    mySpaceUnversioned: '我的空间',
    cancelUnversioned: '取消',
    confirmUnversioned: '确认',
    openUnversioned: '打开',
    closeUnversioned: '关闭',
    doneUnversioned: '完成',
    languageUnversioned: '语言',
    dayUnversioned: '天',
    hourUnversioned: '小时',
    minuteUnversioned: '分钟',
    secondUnversioned: '秒',
    helpUnversioned: '帮助',
    followSystemUnversioned: '跟随系统',
    autoUnversioned: '自动',
    faceIDUnversioned: '面容',
    touchIDUnversioned: '指纹',
    createUnversioned: '创建',
    modifyUnversioned: '修改',
    changeUnversioned: '修改',
    resetUnversioned: '重置',
    selectUnversioned: '选择',
    selectAllUnversioned: '全选',
    unselectAllUnversioned: '取消全选',
    shareUnversioned: '分享',
    deleteUnversioned: '删除',
    deleteAllUnversioned: '删除全部',
    moveUnversioned: '移动',
    copyUnversioned: '复制',
    editUnversioned: '编辑',
    restoreUnversioned: '恢复',
    restoreAllUnversioned: '恢复全部',
    noDataUnversioned: '无数据',
    allUnversioned: '全部',
    enabledUnversioned: '已启动',
    disabledUnversioned: '已禁用',
    closedUnversioned: '已关闭',
    openedUnversioned: '已打开',
  },
